...
def update_db():
    ...
    try:
        c.execute("ALTER TABLE booking ADD COLUMN acara TEXT")
    except:
        pass

    try:
        c.execute("ALTER TABLE booking ADD COLUMN lokasi TEXT")
    except:
        pass
...
Lokasi Maps
<input name="lokasi" placeholder="Link Google Maps / boleh kosong"><br><br>
